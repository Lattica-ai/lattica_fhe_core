...
Num::word Num::word_mask() {
    return (word)-1;
}

size_t Num::word_bits() {
    return sizeof(word) * CHAR_BIT;
}

Num::word Num::word_half_mask() {
    return word_mask() >> word_bits() / 2;
}

Num::word Num::char_to_word(char c) {
    switch (c) {
        case '0': return 0;
        case '1': return 1;
        case '2': return 2;
...
Num::word Num::word_gcd(word a, word b) {
    while (1) {
        if (a == 0) return b;
        b %= a;
        if (b == 0) return a;
...
Num::Num(const char* c, word base, char** endptr) : neg(false) {
    // read sign
    if (*c == '-') {
        c++;
        neg = true;
...
Num::word& Num::operator[](size_t i) {
    return words[i];
}

const Num::word& Num::operator[](size_t i) const {
    return words[i];
}

Num& Num::set_neg(bool _neg) {
    neg = _neg;
    return *this;
}
...
size_t Num::count_trailing_zeros() const {
...
int Num::cmp_abs(const Num& a, const Num& b) {
...
int Num::cmp(const Num& a, const Num& b) {
...
size_t Num::word_bitlength(word a) {
    for (int i = word_bits() - 1; i >= 0; i--) if ((a >> i) & 1) return i + 1;
    return 0;
}

size_t Num::word_count_trailing_zeros(word a) {
    for (int i = 0; i < (int)word_bits(); i++) if ((a >> i) & 1) return i;
    return word_bits();
}

Num::word Num::add_carry(word* a, word b) {
    return (*a += b) < b;
}

Num::word Num::sub_carry(word* a, word b) {
    word tmp = *a;
    return (*a = tmp - b) > tmp;
}

Num::word Num::word_mul_hi(word a, word b) {
...
Num& Num::add_unsigned_overwrite(Num& a, const Num& b) {
...
Num& Num::sub_unsigned_overwrite(Num& a, const Num& b) {
...
Num Num::mul_long(const Num& a, const Num& b) {
...
Num Num::mul_karatsuba(const Num& a, const Num& b) {
...
Num Num::mul(const Num& a, const Num& b) {
...
Num Num::add_signed(const Num& a, bool a_neg, const Num& b, bool b_neg) {
...
Num& Num::operator>>=(size_t n_bits) {
...
void Num::div_mod(const Num& numerator, Num denominator, Num& quotient, Num& remainder) {
    quotient = 0;
    remainder = numerator;
...
void Num::div_mod_half_word(const Num& numerator, word denominator, Num& quotient, word& remainder) {
    remainder = 0;
...
void Num::split(const Num& a, Num* parts, size_t n_parts, size_t n) {
    size_t i = 0;
...
Num Num::div(const Num& numerator, const Num& denominator) {
    Num quotient, remainder;
    div_mod(numerator, denominator, quotient, remainder);
    return quotient;
}

Num Num::mod(const Num& numerator, const Num& denominator) {
    Num quotient, remainder;
    div_mod(numerator, denominator, quotient, remainder);
    return remainder;
}

Num Num::add_unsigned(const Num& a, const Num& b) {
    Num result(a);
    return add_unsigned_overwrite(result, b);
}

Num Num::sub_unsigned(const Num& a, const Num& b) {
    Num result(a);
    return sub_unsigned_overwrite(result, b);
}

Num Num::add(const Num& a, const Num& b) {
    Num result = add_signed(a, a.neg, b, b.neg);
    return result;
}

Num Num::sub(const Num& a, const Num& b) {
    Num result = add_signed(a, a.neg, b, !b.neg);
    return result;
}

Num Num::gcd(const Num& a0, const Num& b0) {
...
Num Num::random_bits(size_t n_bits, random_func func) {
...
Num Num::random_inclusive(const Num& inclusive, random_func func) {
...
Num Num::random_exclusive(const Num& exclusive, random_func func) {
...
Num Num::random_second_exclusive(const Num& inclusive_min_val, const Num& exclusive_max_val, random_func func) {
    return inclusive_min_val + random_exclusive(exclusive_max_val - inclusive_min_val, func);
}

Num Num::random_both_inclusive(const Num& inclusive_min_val, const Num& inclusive_max_val, random_func func) {
    return inclusive_min_val + random_inclusive(inclusive_max_val - inclusive_min_val, func);
}

Num& Num::set_bit(size_t i) {
...
Num::word Num::get_bit(size_t i) const {
    size_t i_word = i / word_bits();
    size_t i_bit = i % word_bits();
...
Num& Num::add_word(word carry, size_t i0) {
...
void Num::print(std::vector<char>& text, word base, const char* alphabet) const {
    if (size() == 0) {
        text.push_back('0');
    } else {
        Num tmp(*this);
...
bool Num::can_convert_to_int(int* result) {
...
Num Num::pow(size_t exponent) const {
    Num result(1), p(*this);
...
Num Num::mod_pow(Num exponent, const Num& modulus) const {
...
Num Num::operator-() const {
    return Num(*this).set_neg(!neg);
}

Num Num::operator>>(size_t n_bits) const {
    return Num(*this) >>= n_bits;
}
